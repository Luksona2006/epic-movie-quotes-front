<template>
  ...
  >
    ...
    <div
      class="w-full absolute right-0 rounded-b-[4px] rounded-br-[4px] bg-black transition-all duration-500 cursor-pointer overflow-y-scroll max-h-28 h-full"
      :class="dropDownClass"
    >
      ...
      <p class="w-full py-6 text-center text-xl font-medium text-white opacity-90" v-else>
        No movies yet
      </p>
    </div>
  </div>
