      ...
      >
        <div class="z-20 flex sm:gap-5 gap-2 items-top">
          ...
          <div class="flex flex-col gap-6">
            ...
            <span class="text-white sm:text-3xl text-base font-bold">Interstellar, 2014</span>
          </div>
        </div>
      </div>
      <!-- 2 -->
...
import TheRedButton from '@/components/TheRedButton.vue'
import TheTransparentButton from '@/components/TheTransparentButton.vue'
